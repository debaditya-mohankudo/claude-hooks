...
class ConceptStore:
    ...
    Each concept:
        ...
        evidence    — list[str] of "file:symbol" references (or bare "file" when
                      the citation has no enclosing symbol); never a line number,
                      since a symbol name doesn't drift the way a line does
